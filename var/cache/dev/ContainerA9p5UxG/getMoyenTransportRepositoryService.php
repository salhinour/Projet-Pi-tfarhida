 ...
 */
class getMoyenTransportRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MoyenTransportRepository' shared autowired service.
     *
     * @return \App\Repository\MoyenTransportRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MoyenTransportRepository.php';

        return $container->privates['App\\Repository\\MoyenTransportRepository'] = new \App\Repository\MoyenTransportRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
