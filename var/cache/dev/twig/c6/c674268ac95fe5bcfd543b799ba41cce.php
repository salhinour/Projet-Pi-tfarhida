...
class __TwigTemplate_9fa0c62f7c2099527c752e980d31d293 extends Template
{
    private $source;
    private $macros = [];
    ...
    {% if segment in app.request.attributes.get('_route') %}
        active
    {% endif %}
{% endmacro %}", "partials/_macro.html.twig", "C:\\Users\\ASUS\\Desktop\\PiDev\\Projet-Pi-tfarhida\\templates\\partials\\_macro.html.twig");
    }
}
