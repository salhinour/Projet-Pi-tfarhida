...
class __TwigTemplate_21e7cfb790c00b7f070b5c2dd591a5b7 extends Template
{
    private $source;
    private $macros = [];
   ...
   ";
    ...
    <div class=\"container\">
        ...
        <div class=\"project-wrap\">
            ...
            <a href=\"";
            // line 145
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_activitee_show", ["id" => twig_get_attribute($this->env, $this->source, $context["activitee"], "id", [], "any", false, false, false, 145)]), "html", null, true);
            ...
            <h3><a href=\"";
            // line 148
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_activitee_show", ["id" => twig_get_attribute($this->env, $this->source, $context["activitee"], "id", [], "any", false, false, false, 148)]), "html", null, true);
            echo "\">";
   ...
   {# <div class=\"tab-pane fade show active\" id=\"v-pills-1\" role=\"tabpanel\" aria-labelledby=\"v-pills-nextgen-tab\">
    ...
    <div class=\"col-md-4 ftco-animate project-wrap\" data-activity-name=\"{{ activitee.nom|lower }}\">
        <div class=\"project-wrap\">
            ...
            <a href=\"{{ path('app_activitee_show', {'id': activitee.id}) }}\" class=\"img\" style=\"background-image: url('{{ asset('uploads/' ~ activitee.image) }}');\">
                <span class=\"price\">{{ activitee.prix }}DT/personne</span>
            </a>
            <h3><a href=\"{{ path('app_activitee_show', {'id': activitee.id}) }}\">{{ activitee.nom }}</a></h3>
...
", "activitee/activite.html.twig", "C:\\Users\\ASUS\\PiProjecttt\\templates\\activitee\\activite.html.twig");
    }
}
