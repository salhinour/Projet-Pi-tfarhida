...
class __TwigTemplate_5dccc98d16386ae07bc0f58e21b70984 extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        $this->parent = $this->loadTemplate("base.html.twig", "trajet/show.html.twig", 1);
    ...
    <a href=\"";
        // line 29
        echo $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_trajet_index");
        echo "\">back to list</a>

    <a href=\"";
        // line 31
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_trajet_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["trajet"]) || array_key_exists("trajet", $context) ? $context["trajet"] : (function () { throw new RuntimeError('Variable "trajet" does not exist.', 31, $this->source); })()), "id", [], "any", false, false, false, 31)]), "html", null, true);
        echo "\">edit</a>

    ";
        // line 33
        echo twig_include($this->env, $context, "trajet/_delete_form.html.twig");
        echo "
";
...
{% block body %}
    ...
    <a href=\"{{ path('app_trajet_index') }}\">back to list</a>

    <a href=\"{{ path('app_trajet_edit', {'id': trajet.id}) }}\">edit</a>

    {{ include('trajet/_delete_form.html.twig') }}
{% endblock %}
", "trajet/show.html.twig", "C:\\Users\\ASUS\\Desktop\\PiDev\\Projet-Pi-tfarhida\\templates\\trajet\\show.html.twig");
    }
}
