...
/* baseback.html.twig */
class __TwigTemplate_04e3012015d6d68d43b99252d02e1802 extends Template
{
    private $source;
    private $macros = [];
...
<ul class=\"navbar-nav bg-gradient-primary sidebar sidebar-dark accordion\" id=\"accordionSidebar\">
    ...
    <img src=\"";
        // line 71
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\AssetExtension']->getAssetUrl("/sbadmin2/logo.png"), "html", null, true);
        echo "\" alt=\"Votre Image\" class=\"logo\">
</div>
    <hr class=\"sidebar-divider my-0\">
...
";
        ...
        // line 275
        echo "<div id=\"sfwdt5e5522\" class=\"sf-toolbar\" role=\"region\" aria-label=\"Symfony Web Debug Toolbar\" data-sfurl=\"http://127.0.0.1:8000/_wdt/5e5522\" style=\"display: block;\"><!-- START of Symfony Web Debug Toolbar -->
...
function createPDF() {
    ...
    <script>
        function myFunction() {
          ...
          input = document.getElementById(\"table-actions\");
        ...
        function sortTable(n) {
          ...
          table-actions = document.getElementById(\"table-actions\");
          switching = true;
          dir = \"asc\";

          while (switching) {
            switching = false;
            rows = table-actions.rows;
    ...
    {
        return array (  700 => 199,  698 => 195,  688 => 194,  677 => 161,  667 => 160,  253 => 275,  251 => 194,  217 => 162,  215 => 160,  140 => 88,  130 => 81,  117 => 71,  45 => 1,);
    }
...
<ul class=\"navbar-nav bg-gradient-primary sidebar sidebar-dark accordion\" id=\"accordionSidebar\">
    ...
    <div class=\"sidebar-brand-text mx-3\">
    <img src=\"{{ asset('/sbadmin2/logo.png') }}\" alt=\"Votre Image\" class=\"logo\">
</div>
    <hr class=\"sidebar-divider my-0\">
    ...
    <li class=\"nav-item             active
    \">
        <a class=\"nav-link\" href=\"{{ path('app_activitee_back_index') }}\" aria-expanded=\"false\">
            <i class=\"fas fa-user\"></i>
            <span>Activite</span>
        </a>
    </li>
     <li class=\"nav-item             active
    \">
        <a class=\"nav-link\" href=\"{{ path('app_categorie_back_c_index') }}\" aria-expanded=\"false\">
            <i class=\"fas fa-user\"></i>
            <span>Categorie</span>
        </a>
    </li>
...
</body></html>", "baseback.html.twig", "C:\\Users\\ASUS\\PiProjecttt\\templates\\baseback.html.twig");
    }
}
