 ...
 */
class getActiviteeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ActiviteeRepository' shared autowired service.
     *
     * @return \App\Repository\ActiviteeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ActiviteeRepository.php';

        return $container->privates['App\\Repository\\ActiviteeRepository'] = new \App\Repository\ActiviteeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
